 ...
 * to a "public" EJB (an EJB without declarative role checking).
 * 
 * @author Arjan Tijms
 *
 */
@RunWith(Arquillian.class)
public class PublicEJBPropagationIT extends ArquillianBase {
	...
	public void testProtectedServletWithLoginCallingEJB() {
		...
		driver.get(deploymentUrl + "protected/servlet-public-ejb?doLogin=true");
